...
<head>
    ...
    <title>Email Verified - GV LIVE</title>
...
<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-neonPurple/10 rounded-full blur-[100px] pointer-events-none"></div>

<!-- Main Card -->
<main class="relative z-10 w-full max-w-sm mx-4">

    <!-- Clean Container -->
    <div class="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-10 text-center shadow-2xl">
        ...
        <p class="text-gray-400 text-sm mb-8 leading-relaxed">
            Welcome to <span class="text-neonPink font-medium">GV LIVE</span>. Your account has been activated successfully.
        </p>
    </div>
</main>
